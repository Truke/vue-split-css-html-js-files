(function () {
    window.EC_SoftPhone = window.EC_SoftPhone || {
            ...
            init: function (media_ip, media_port, sip_id, sip_pwd) {
                ...
                EC_SoftPhone.RegisterCallBack(EC_SoftPhone.ecsdk, "OnIncomingCallReceived", EC_SoftPhone.onCallIncoming);
            ...
            UnInitialize: function (callback) {
                ...
                if (EC_SoftPhone.ecsdk.UnInitialize){
                    ...
                    CallCenter.log("ECSDK:卸载控件,控件为空");
                }
            ...
            Logout: function (callback) {
                ...
                if (EC_SoftPhone.ecsdk.Logout) {
                    ...
                    CallCenter.log("ECSDK:登出话机失败:登出ecsdk.Logout为空");
                }
            },
            /**
             * 外呼
             ...
             * @param coming
             */
            onCallIncoming: function (coming) {
                CallCenter.log("ECSDK:onCallIncoming");
                //如果是自动外呼或主动外呼，话机直接接听
